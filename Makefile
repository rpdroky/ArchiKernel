...
KERNELFLAGS	= -pipe -DNDEBUG -Ofast
MODFLAGS	= -DMODULE $(KERNELFLAGS)

HOSTCC       = gcc
HOSTCXX      = g++
HOSTCFLAGS   = -Wall -Wmissing-prototypes -Wstrict-prototypes $(KERNELFLAGS) -fomit-frame-pointer -std=gnu89
HOSTCXXFLAGS = $(KERNELFLAGS)
